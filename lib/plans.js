...
export const PLANS = [
  {
    ...
    yearlyLabel: 'Annuel',
    billing: {
      monthly: { autoRenew: true, note: 'Renouvellement automatique chaque mois, résiliable à tout moment.' },
      yearly: { autoRenew: true, note: 'Renouvellement automatique chaque année, résiliable à tout moment.' },
    },
